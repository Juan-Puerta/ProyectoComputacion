...
public class Autotransition implements Serializable {
	...
	@NotBlank(groups = {ValidacionDos.class}, message = "El nombre no debe de ser vacio")
	@Column(name="AUTOTRAN_NAME")
	private String autotranName;

	@NotNull(groups= {ValidacionUno.class}, message="La institucion no debe de ser nulo")
	...
	@ManyToOne
	@NotNull(groups= {ValidacionUno.class}, message="El estado no debe de ser nulo")
