...
public class Localcondition implements Serializable {
	...
	@ManyToOne
	@NotNull(groups= {ValidacionUno.class}, message="La precondicion no debe de ser nula")
	@JoinColumn(name="PRECON_PRECON_ID")
	private Precondition precondition;

	//bi-directional many-to-one association to Threshold
	@ManyToOne
	@NotNull(groups= {ValidacionUno.class}, message="El threshold no debe de ser nulo")
