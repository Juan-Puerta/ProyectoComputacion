package com.tallerOne.main.model;
...
public class Threshold implements Serializable {
	...
	@NotNull(groups = {ValidacionDos.class}, message="La institucion no debe de ser nula")
	@Column(name="INST_INST_ID")
	private BigDecimal instInstId;

	@NotBlank(groups = {ValidacionUno.class}, message="El nombre no debe de ser vacio")
	@Column(name="THRES_NAME")
	private String thresName;

	@NotBlank(groups = {ValidacionUno.class}, message="El valor no debe de ser vacio")
